...
local compVarName = "typeList"

local tOpts = 
{
	--{ id, "switch type", initState, left, "composerVarName" },

	{ "ANY", "radio", 50, "typeAny" },
	{ "Select Types", "radio", 50, "typeSel"  },
}
...
function scene:create( event )
	...
	optHeader, canvasTop = AddText( sceneGroup, "Type Options", 20, 0, 0, 0, 1, _W/2.0, event.params.originY+15, 10 )
	optText, canvasTop = AddText( sceneGroup, "Ask About Which Types", 16, 0, 0, 0, 1, _W/2.0, canvasTop, 0 )
